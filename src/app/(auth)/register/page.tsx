      ...
      <div className="grid w-full max-w-5xl overflow-hidden rounded-2xl border border-slate-200 md:grid-cols-2">
        ...
        <div className="p-8 sm:p-10">
          ...
          <div className="mt-8 space-y-3">
            <Button variant="outline" className="w-full" onClick={() => router.push("/register/username")}>Continue with Google</Button>
            <Button variant="outline" className="w-full" onClick={() => router.push("/register/username")}>Continue with Apple</Button>
            <Button variant="outline" className="w-full" onClick={() => router.push("/register/username")}>Continue with GitHub</Button>
          </div>
